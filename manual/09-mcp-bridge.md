...
— Claude Code, Claude Desktop, OpenCode and others — work the patch as if it
were you at the canvas: adding and moving modules, connecting and cutting
cables, setting parameters, mutating a patch, opening patches from your library,
saving them, and storing them to a synth bank.
